        ...
        <div className="mx-auto max-w-7xl px-6 py-10 lg:px-10">
          ...
          <div className="mt-8">
            ...
            <p className="mt-3 max-w-2xl text-[#AAAAAA]">
              ...
              currently available on AGTIMES.
            </p>
          </div>
        </div>
      </section>
        ...
        {movies.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-white/10 bg-[#1C1C1C] p-12 text-center">
            ...
            <p className="mt-2 text-[#AAAAAA]">
              Trending movies will appear here when movies are
              added.
            </p>
          </div>
        ) : (
              ...
              {movies.map((movie, index) => (
                ...
                >
                  <div className="relative aspect-[2/3] overflow-hidden">
                    ...
                    <div className="absolute left-3 top-3 flex h-9 w-9 items-center justify-center rounded-full bg-[#2979FF] text-sm font-bold">
                      #{index + 1}
                    </div>
